    ...
    public partial class MainForm : Form
    {
        ...
        private void gameNotification(GameEngine.NotificationArgs args)
        {
            ...
            if (ran < 0.30)
            {
                ...
                $"{args.Attacker.Name} attacked {args.Defender.Name} with the special ability {args.Attacker.Weapon.SpecialAbility()} for {Math.Round(args.Attack, 2)} and caused {Math.Round(args.Damage, 2)} damage.\r\n");
            }
            tbAttacker.AppendText(
